...
class BertForPairwiseMatching(BertPreTrainedModel):
    """
    Bert model adapted for pairwise matching
    """

    def __init__(self, config, pos_weight=None, weight=None):
        super(BertForPairwiseMatching, self).__init__(config)
    ...
    def forward(
        ...
        pooled_output = torch.cat([outputs_a[1], outputs_b[1]], axis=1)
