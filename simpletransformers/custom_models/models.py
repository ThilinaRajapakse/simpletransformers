...
class ElectraForLanguageModelingModel(PreTrainedModel):
    def __init__(self, config, **kwargs):
        ...
        if "generator_model" in kwargs:
            self.generator_model = kwargs["generator_model"]
        else:
        ...
        if "discriminator_model" in kwargs:
            self.discriminator_model = kwargs["discriminator_model"]
        else:
        ...
        self.vocab_size = self.generator_model.config.vocab_size
