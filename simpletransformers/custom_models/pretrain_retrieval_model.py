...
from transformers.models.dpr.modeling_dpr import DPRPretrainedContextEncoder, DPRContextEncoder
...
class PretrainRetrievalContextEncoder(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.representation_head = BertPooler(config)
    ...
    def forward(
        ...
        if not return_dict:
            representation_outputs = (sequence_output, pooled_output) + encoder_outputs[1:]
            span_prediction_outputs = (start_logits, end_logits) + encoder_outputs[1:]
            return representation_outputs, span_prediction_outputs

        representation_outputs = BaseModelOutputWithPoolingAndCrossAttentions(
        ...
        span_prediction_outputs = QuestionAnsweringModelOutput(
